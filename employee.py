...
# ==================================================================
        ...
        # ----------option--------------
        cmb_search = ttk.Combobox(search_frame, textvariable=self.var_searchby, values=("select", "Email", "Name", "Contact"), stat="readonly", justify=CENTER, font=("goudy old style", 15))
        cmb_search.place(x=10, y=10, width=180)
        cmb_search.current(0)

        txt_search = Entry(search_frame, textvariable=self.var_searchtxt, font=("goudy old style", 15), bg='lightyellow').place(x=200, y=11)
        btn_search = Button(search_frame, text="Search", command=self.search, font=("goudy old style", 15,"bold"),bg='#ffde0a', fg="black", cursor="hand2").place(x=435, y=9, width=150, height=30)

        # ---------title and header---------
        title = Label(self.root, text="Employee Details", font=("goudy old style", 20,"bold"), bg='#0f4d74', fg="white").place(x=50, y=100, width=1000)
        ...
        cmb_gender = ttk.Combobox(self.root, textvariable=self.var_gender, values=("select", "Male", "Female", "Other"), stat="readonly", justify=CENTER, font=("goudy old style", 15))
        ...
        txt_email = Entry(self.root, textvariable=self.var_email_id, font=("goudy old style", 15), bg='lightyellow').place(x=150, y=230, width=180)
        ...
        cmb_user_type = ttk.Combobox(self.root, textvariable=self.var_utype, values=("Admin", "Employee"), stat="readonly", justify=CENTER, font=("goudy old style", 15))
        cmb_user_type.place(x=850, y=230, width=180)
        cmb_user_type.current(0)

        # =========Row 4===========
        lbl_address = Label(self.root, text="Address", font=("goudy old style", 15), bg='white').place(x=50, y=270)
        lbl_salary = Label(self.root, text="Salary", font=("goudy old style", 15), bg='white').place(x=498, y=270)
        ...
        # ===========Buttons===========
        btn_save = Button(self.root, text="Save", command=self.add, font=("goudy old style", 15,"bold"),bg='#2196f3', fg="white", cursor="hand2").place(x=500, y=305, width=110, height=28)
        btn_update = Button(self.root, text="Update", command=self.update, font=("goudy old style", 15,"bold"), bg='#2dfa16',fg="white", cursor="hand2").place(x=620, y=305, width=110, height=28)
        btn_delete = Button(self.root, text="Delete", command=self.delete, font=("goudy old style", 15,"bold"), bg='red',fg="white", cursor="hand2").place(x=740, y=305, width=110, height=28)
